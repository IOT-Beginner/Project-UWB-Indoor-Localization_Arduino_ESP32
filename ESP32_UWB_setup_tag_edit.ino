...
#define N_ANCHORS 6   //THIS VERSION WORKS ONLY WITH 4 ANCHORS. May be generalized to 5 or more.
#define ANCHOR_DISTANCE_EXPIRED 5000   //measurements older than this are ignore (milliseconds)

// WiFi credentials
const char* ssid = "AIS 4G Hi-Speed Home WiFi_544638"; //"AIS 4G Hi-Speed Home WiFi_544638"
const char* password = "51544638"; //"51544638"
...
void newRange()
{
  ...
  if ( (detected == N_ANCHORS)) { //Six recent measurements
